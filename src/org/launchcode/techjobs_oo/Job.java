...
public class Job {
    ...
    public String toString() {
        ...
        String aEmployer = employer.toString();
        String aLocation = location.toString();
        String aPositionType = positionType.toString();
        String aCoreCompetency = coreCompetency.toString();
